...
function Form({ id }: FormProps) {
  ...
  return (
    <div id="contact-form" className="flex flex-col md:flex-row gap-6 md:gap-10 p-6 md:p-10 bg-black text-white mx-4 sm:mx-[10%] lg:mx-[20%] border-white border-2 mb-6 md:mb-8">
      {/* Left Section */}
