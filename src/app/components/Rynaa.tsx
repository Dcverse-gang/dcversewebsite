    ...
    <div className="mx-4 sm:mx-[10%] lg:mx-[20%] border-2 border-white bg-black bg-opacity-50 backdrop-blur-sm font-poppins text-white">
      <div className="flex flex-col md:flex-row">
        <div className="flex-1 flex flex-col">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 text-center font-poppins pt-4">
            RYNAA
          </h1>
          ...
          <p className="text-xl sm:text-2xl md:text-3xl mt-4 sm:mt-6 font-semibold mb-4 px-4 sm:ml-8 sm:mr-20 text-center sm:text-left">
            ...
            #AvantGardeFashion #FashionAsArt.
          </p>

          <div className="flex gap-3 sm:gap-4 mb-4 mt-4 justify-center sm:justify-start sm:ml-8">
            <span className="px-3 py-1 bg-[#4EBF74] text-black rounded-full text-base sm:text-lg font-poppins">
              Trendsetter
            </span>
            <span className="px-3 py-1 bg-[#8C4EBF] text-black rounded-full text-base sm:text-lg font-poppins">
              Fearless
            </span>
          </div>
